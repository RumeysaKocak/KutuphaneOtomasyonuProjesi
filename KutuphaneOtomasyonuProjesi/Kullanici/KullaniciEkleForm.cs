...
namespace KutuphaneOtomasyonuProjesi.Kullanici
{
    public partial class KullaniciEkleForm : Form
    {
        ...
        private void lblCeza_Click(object sender, EventArgs e)
        {
        ...
        private void txtKullaniciSoyad_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtKullaniciTel_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtKullaniciCeza_TextChanged(object sender, EventArgs e)
        {
